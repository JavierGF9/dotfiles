...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "main", "web", "dev", "mail", "other", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = awful.util.table.join(
    ...
    -- Volume control
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.spawn("amixer sset Master 5%+") end, {description = "increase volume", group = "custom"}),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.spawn("amixer sset Master 5%-") end, {description = "decrease volume", group = "custom"}),
    ...
    awful.key({ }, "Print",
        function ()
            awful.spawn("mate-screenshot")
        end,
        {description = "print screen", group = "other"}
    ),
    awful.key({"Control"}, "Print",
        function ()
            awful.spawn("mate-screenshot -wB")
        end,
        {description = "print window", group = "other"}
    ),
...
awful.rules.rules = {
    ...
    { rule = {
        class = "Thunderbird"
      }, properties = { tag = awful.tag.find_by_name(awful.screen.focused(), "mail") }
    },

    { rule = {
        class = "Telegram"
      }, properties = { tag = awful.tag.find_by_name(awful.screen.focused(), "other") }
    },
